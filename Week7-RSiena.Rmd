...
# Figuring out relative influence
...
# packageurl <- "https://cran.r-project.org/src/contrib/Archive/RSiena/RSiena_1.3.0.tar.gz"
# install.packages(packageurl, repos=NULL, type="source")


RI <- sienaRI(data = data_siena, ans = ansM1)


plot(RI, addPieChart = TRUE, radius = 1, legendColumns = 3) 
